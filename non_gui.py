...
trainNetwork(stage, num_of_actions, lockmode, is_simple_actions_locked, is_activate_boss_memory,is_sweet_boss, max_steps , resume_Adam=False, is_resume_RB_in_drive=False, is_brute_exploring=is_brute_exploring, learning_rate=learning_rate, event=None, is_colab=True)
